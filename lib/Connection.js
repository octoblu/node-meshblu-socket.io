...
function Connection(opt, dependencies){
  ...
  this._throttledProcessEmitStack = _.bind(_.throttle(this._processEmitStack, DEFAULT_BUFFER_RATE), this);
...
Connection.prototype.status = function(fn) {
  this.bufferedSocketEmit('status', {}, fn);
  return this;
};

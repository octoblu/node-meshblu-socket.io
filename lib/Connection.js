...
Connection.prototype.unregister = function(data) {
  this.socket.emit('unregister', data);
  return this;
};

Connection.prototype.whoami = function(data) {
  this.socket.emit('whoami', data);
  return this;
};

Connection.prototype.devices = function(data) {
  this.socket.emit('devices', data);
  return this;
};

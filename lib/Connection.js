...
var DEFAULT_CONNECTION_TIMEOUT = 10000;
...
Connection.prototype.connect = function(){
  ...
  self.connectionTimer = setTimeout(function(){self.emit('notReady', {code: 504, message: 'Connection Timeout'})}, self.connectionTimeout);
  self.setup();
};
